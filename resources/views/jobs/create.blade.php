                    ...
                    <form method="POST" action="{{ route('jobs.store') }}">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="employment_type" class="block mt-1 w-full" type="text" name="employment_type" placeholder="Full-time, Part-time, Contract" />
                            ...
                            <div>
                                ...
                                <x-text-input id="salary_range" class="block mt-1 w-full" type="text" name="salary_range" placeholder="e.g. $50,000 - $70,000" />
                            ...
                            <div>
                                ...
                                <x-text-input id="application_deadline" class="block mt-1 w-full" type="date" name="application_deadline" />
                            ...
                            <div>
                                ...
                                <x-text-input id="contact_phone" class="block mt-1 w-full" type="tel" name="contact_phone" />
                            ...
                            <div>
                                ...
                                <x-text-input id="website" class="block mt-1 w-full" type="url" name="website" placeholder="https://" />
                            ...
                            <div>
                                ...
                                <x-text-input id="skills_required" class="block mt-1 w-full" type="text" name="skills_required" placeholder="PHP, Laravel, MySQL" />
                            ...
                            <div>
                                ...
                                <x-text-input id="skills_preferred" class="block mt-1 w-full" type="text" name="skills_preferred" placeholder="Vue.js, AWS, Docker" />
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea id="description" name="description" rows="6" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" required></textarea>
